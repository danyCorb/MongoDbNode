...
const ENTITY_NAME = "individu";
const ENTITY_NAME_PLURAL = "individus";
const ENTITY_FILE_PATH = "individus/individus.json"
const FIELDS = ["nom", "prenom", "age", "nb_cafe", "sexe", "matieres", "salaire"];
